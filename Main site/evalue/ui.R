            ...
            tabPanel("More resources",
                     ...
                     mainPanel(      HTML(paste( "<b>Developers</b>",
                                            ...
                                            <a href='https://sites.google.com/site/pengdingpku/'>Peng Ding</a>, <a href='https://sph.berkeley.edu/corinne-riddell-phd'>Corinne Riddell</a>, and <a href='https://www.hsph.harvard.edu/tyler-vanderweele/tools-and-tutorials/'>Tyler VanderWeele</a>.",
                                                 ...
                                                 "<br><br><b>Other software for E-values</b>",
                                       ...
                                       the Stata module <a href='https://ideas.repec.org/c/boc/bocode/s458592.html'>EVALUE</a>.",
                                                 ...
                                                 "<br><br><b>Analogous sensitivity analyses for other settings and biases</b>",
                                                 
                                                 "<br><br>If you are concerned about <a href='https://www.tandfonline.com/doi/full/10.1080/01621459.2018.1529598'>unmeasured confounding in a meta-analysis</a> rather than a single study,
                                                  you can conduct sensitivity analyses analogous to the E-value using the R package <a href='https://cran.r-project.org/web/packages/EValue/index.html'>EValue</a>
or <a href='https://mmathur.shinyapps.io/meta_gui_2/'>this website</a>. If you are concerned about <a href='https://arxiv.org/abs/1810.13402'>selection bias</a> instead of (or in addition to) confounding, you can conduct analogous sensitivity analyses
                                              using the R package <a href='https://cran.r-project.org/web/packages/EValue/index.html'>EValue</a>.",
                                                 ...
                                                 "<br><br><a href='https://biostats.bepress.com/harvardbiostat/paper215/'>(2) VanderWeele TJ, Ding P, Mathur MB. (in press). Technical considerations in the use of the E-value. <i>Journal of Causal Inference</i>.",
